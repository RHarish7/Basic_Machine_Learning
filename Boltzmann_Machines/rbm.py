...
training_set1 = pd.read_csv('ml-100k/u2.base', delimiter = '\t')
training_set1 = np.array(training_set1, dtype = 'int')

training_set = np.append(training_set,training_set1, axis=0)

training_set1 = pd.read_csv('ml-100k/u3.base', delimiter = '\t')
training_set1 = np.array(training_set1, dtype = 'int')

training_set = np.append(training_set,training_set1, axis=0)

training_set1 = pd.read_csv('ml-100k/u4.base', delimiter = '\t')
training_set1 = np.array(training_set1, dtype = 'int')

training_set = np.append(training_set,training_set1, axis=0)

training_set1 = pd.read_csv('ml-100k/u5.base', delimiter = '\t')
training_set1 = np.array(training_set1, dtype = 'int')
...
test_set = pd.read_csv('ml-100k/u4.test', delimiter = '\t')
test_set1 = np.array(test_set1, dtype = 'int')
